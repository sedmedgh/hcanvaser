---
title: "Options"
description: "Explore the different configuration options available for nenehtml2canvas"
...
| removeContainer | `true` | Whether to cleanup the cloned DOM elements nenehtml2canvas creates temporarily
...
If you wish to exclude certain `Element`s from getting rendered, you can add a `data-nenehtml2canvas-ignore` attribute to those elements and nenehtml2canvas will exclude them from the rendering.
