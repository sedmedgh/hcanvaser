...
const IGNORE_ATTRIBUTE = 'data-nehtml2canvas-ignore';
...
export class DocumentCloner {
    ...
    createCustomElementClone(node: HTMLElement): HTMLElement {
        const clone = document.createElement('nehtml2canvascustomelement');
    ...
    resolvePseudoContent(
        ...
        const anonymousReplacedElement = document.createElement('nehtml2canvaspseudoelement');
...
const createIFrameContainer = (ownerDocument: Document, bounds: Bounds): HTMLIFrameElement => {
    ...
    cloneIframeContainer.className = 'nehtml2canvas-container';
...
const PSEUDO_HIDE_ELEMENT_CLASS_BEFORE = '___nehtml2canvas___pseudoelement_before';
const PSEUDO_HIDE_ELEMENT_CLASS_AFTER = '___nehtml2canvas___pseudoelement_after';
