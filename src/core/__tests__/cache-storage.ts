...
describe('cache-storage', () => {
    ...
    describe('cross-origin', () => {
        it('addImage should not add images it cannot load/render', async () => {
            ...
            await cache.addImage('http://nehtml2canvas.hertzen.com/test.jpg');
            deepStrictEqual(images.length, 0);
        });
        ...
        it('addImage should add images if tainting enabled', async () => {
            ...
            await cache.addImage('http://nehtml2canvas.hertzen.com/test.jpg');
            deepStrictEqual(images.length, 1);
            deepStrictEqual(images[0].src, 'http://nehtml2canvas.hertzen.com/test.jpg');
        ...
        it('addImage should use proxy ', async () => {
            ...
            deepStrictEqual(
                xhr[0].url,
                `${proxy}?url=${encodeURIComponent('http://nehtml2canvas.hertzen.com/test.jpg')}&responseType=text`
            );
        ...
        it('proxy should respect imageTimeout', async () => {
            ...
            try {
                await cache.match('http://nehtml2canvas.hertzen.com/test.jpg');
