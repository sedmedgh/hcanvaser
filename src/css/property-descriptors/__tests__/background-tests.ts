...
describe('property-descriptors', () => {
    ...
    describe('background-image', () => {
        ...
        it(`linear-gradient(to bottom, rgba(255,255,0,0.5), rgba(0,0,255,0.5)), url('https://nehtml2canvas.hertzen.com')`, () =>
            deepStrictEqual(
                backgroundImageParse(
                    context,
                    `linear-gradient(to bottom, rgba(255,255,0,0.5), rgba(0,0,255,0.5)), url('https://nehtml2canvas.hertzen.com')`
                ),
                [
                    {
                        angle: deg(180),
                    ...
                    {url: 'https://nehtml2canvas.hertzen.com', type: CSSImageType.URL}
                ]
            ));
    });
});
